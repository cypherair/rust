...
fn main() {
    rustc()
        ...
        .run();
    assert_no_illegal_direct_ptrauth("module.ll");

    llvm_dis().input("module.bc").arg("-o").arg("module-bc.ll").run();
    assert_no_illegal_direct_ptrauth("module-bc.ll");
    ...
    assert_no_illegal_direct_ptrauth("embedded.ll");
}
